...
goal: G-003
scope_version: 1
approval_basis: Owner selected the staged Codex / Claude Design / Claude Code workflow on 2026-09-15 and explicitly requested preparation for current and future mocked UI capabilities. Visual design remains subject to owner review.
---
