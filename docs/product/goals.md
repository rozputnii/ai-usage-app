...
The authorized Windows Sandbox enablement completed successfully and reported that a host restart is required. Execution is now blocked on that owner-controlled restart. No automatic reboot was performed or inferred as authorized; all remaining product/remote/host-trust boundaries are unchanged.
